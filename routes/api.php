...
use App\Http\Controllers\Api\PdfTranslationController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/pdf-translations', [PdfTranslationController::class, 'index']);
    Route::post('/pdf-translations', [PdfTranslationController::class, 'store']);
    Route::post('/pdf-translations/{job}/retry', [PdfTranslationController::class, 'retry']);
    Route::get('/pdf-translations/{job}/download/{type}', [PdfTranslationController::class, 'download'])->whereIn('type', ['original', 'translated']);
    Route::delete('/pdf-translations/{job}', [PdfTranslationController::class, 'destroy']);
