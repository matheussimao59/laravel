        ...
        $this->postJson('/api/shopee/analyze-listings', [
            ...
            ->assertJsonStructure([
                'analysis' => [
                    ...
                    'competitor' => ['capture_source', 'photo_count'],
                    'mine' => ['capture_source', 'photo_count'],
                    'diagnosis',
                    'comparisons',
                    'actions',
                    'suggested_title',
            ...
            ->assertJsonPath('analysis.competitor.photo_count', 6)
            ->assertJsonPath('analysis.mine.photo_count', 1)
